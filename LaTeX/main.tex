...
\begin{figure}
    ...
    \caption{Mapa de calor do número de registros por câmera de radar. Podemos observar que o maior número de câmeras de radar e detecções válidas se concentram em areas como Centro, Tijuca e Barra Olímpica.}
...
Outra maneira de identificar placas clonadas é verificar a existência de dois registros da mesma placa, distantes um do outro, com uma pequena diferença de \textit{datahora} do registro. Podemos assumir que, dada uma distância suficientemente grande e uma diferença entre \textit{datahora} ($\Delta t$) suficientemente pequena, é impossível que seja o mesmo veículo em ambos os locais.
