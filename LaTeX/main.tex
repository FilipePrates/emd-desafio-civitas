...
O sistema classifica os veículos refistrados em 4 \textit{tipoveiculo}s diferentes, observando as velocidades médias de cada tipo de veículo, podemos propôr hipóteses de qual \textit{tipoveiculo} hasheado refere a qual tipo de veículo real (Figura \ref{fig:tipoVeiculoAvgSpeed}).
